...
installDepend() {
    ...
    if ! command_exists fastfetch; then
        ...
        LATEST_RELEASE=$(curl -v https://api.github.com/repos/fastfetch-cli/fastfetch/releases/latest | grep "browser_download_url" | grep "fastfetch-linux-amd64.deb" | cut -d '"' -f 4)
